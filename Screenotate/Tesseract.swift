...
let tesseractPath = (resourcePath as NSString).stringByAppendingPathComponent("tesseract")
...
func pngToText(png: NSData) -> String {
    ...
    let fileURL = NSURL.fileURLWithPath((NSTemporaryDirectory() as NSString).stringByAppendingPathComponent(fileName as String))
